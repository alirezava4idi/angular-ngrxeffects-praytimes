...
import { provinceReducer, provincesReducer, setAllCitiesReducer } from '../app/reducers/cityandprovince.reducers';
...
@NgModule({
  ...
  imports: [
    BrowserModule,
    AppRoutingModule,
    StoreModule.forRoot({ info: infoReducer, status: infoLoadStatusReducer, provinces:  provincesReducer, province: provinceReducer, cities: setAllCitiesReducer}, {}),
